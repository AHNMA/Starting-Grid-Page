...
const animationSettings = paths.map(() => ({
...
export const BackgroundBeams = React.memo(
  ({ className }: { className?: string }) => {
    return (
      <div
        className={cn(
          "absolute inset-0 flex h-full w-full items-center justify-center bg-[#121212] [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] [mask-repeat:no-repeat] [mask-size:100%]",
          className,
        )}
      >
        <svg
